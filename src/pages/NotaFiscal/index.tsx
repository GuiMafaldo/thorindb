...
import { DanfeContainer, Header, CompanyInfo, NfeInfo, NaturezaOperacao, FormField, Label, Input, TableContainer, Table, Button, CaculoImposto } from "../NotasFiscais/NotaSaida/styles";
